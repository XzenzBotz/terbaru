...
async function startpapah() {
    ...
    // Get Profile Picture Group
       ...
       papah.send5ButImg(pea[0].id, `「 *Group Settings Change* 」\n\nGroup telah ditutup oleh admin, Sekarang hanya admin yang dapat mengirim pesan !`, `Group Settings Change Message by Xzn-Bot`, wm_papahdev, [])
       } else if(pea[0].announce == false) {
       papah.send5ButImg(pea[0].id, `「 *Group Settings Change* 」\n\nGroup telah dibuka oleh admin, Sekarang peserta dapat mengirim pesan !`, `Group Settings Change Message by Xzn-Bot`, wm_papahdev, [])
       } else if (pea[0].restrict == true) {
       papah.send5ButImg(pea[0].id, `「 *Group Settings Change* 」\n\nInfo group telah dibatasi, Sekarang hanya admin yang dapat mengedit info group !`, `Group Settings Change Message by papah Xzn-Bot`, wm_papahdev, [])
       } else if (pea[0].restrict == false) {
       papah.send5ButImg(pea[0].id, `「 *Group Settings Change* 」\n\nInfo group telah dibuka, Sekarang peserta dapat mengedit info group !`, `Group Settings Change Message by Xzn-Bot`, wm_papahdev, [])
       } else {
       papah.send5ButImg(pea[0].id, `「 *Group Settings Change* 」\n\nGroup Subject telah diganti menjadi *${pea[0].subject}*`, `Group Settings Change Message by Xzn-Bot`, wm_papahdev, [])
     }
    })
