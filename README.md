...
naze && zen hanya menghilangkat bug, memperbagus & menyeting banyak hal
...
<p align="center">
	<img src="https://telegra.ph/file/cfcfafdc15545fcbc05fb.jpg " width="35%" style="margin-left: auto;margin-right: auto;display: block;">
</p>
<p align="center">
...
<h1 align="center">NAZE DEV × XZENNZ</h1>
...
```bash
git clone https://github.com/XzenzBotz/biasa
cd biasa
npm install
```
...
* [`Xzennz`](https://github.com/XzenzBotz)
